...
@section('content')
    ...
    id="reference_number"
    :value="old('reference_number', $nextId . '/KT/' . $bulanRomawiNow . '/' . $yearNow)"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const bulanRomawi = @json($bulanRomawiNow);
        const year = @json($yearNow);

        classificationSelect.addEventListener('change', function () {
            const kode = classificationSelect.value || 'XXX';
            referenceInput.value = `${nextId}/KT-${kode}/${bulanRomawi}/${year}`;
        });
    });
</script>
@endpush
